...
const LOCALES: Record<string, string> = {
  ...
  ml: 'ml-IN',
  pa: 'pa-IN',
  // Odia. On-device recognisers vary in their Odia support; when the
  // platform lacks it, recognition simply reports an error and the screen
  // falls back to the record-then-transcribe flow, which uses Sarvam.
  or: 'or-IN',
};
