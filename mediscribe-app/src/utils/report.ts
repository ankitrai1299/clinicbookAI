...
const HI_LABELS: Record<string, string> = {
  ...
  'Generated by AnvayaScribe • This is a computer-generated clinical document.':
    'अन्वयScribe द्वारा निर्मित • यह एक कंप्यूटर-जनित नैदानिक दस्तावेज़ है।',
...
function letterheadHtml(meta: ReportMeta): string {
  const clinic = escapeHtml(meta.clinicName || 'Clinic');
  const docLine = [
...
<body>
  ...
  <div class="footer">
    ${escapeHtml(L('Generated by AnvayaScribe • This is a computer-generated clinical document.'))}
