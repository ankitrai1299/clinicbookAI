...
export const LANGUAGES: { code: string; label: string }[] = [
  ...
  // The label is sent to the backend verbatim (see languageLabel below), which
  // lowercases it to look up Sarvam's code — so it must stay exactly "Odia".
  // Sarvam's own code is od-IN even though the ISO code is `or`; the mapping
  // lives in the backend's sarvamStt.ts.
  { code: 'or', label: 'Odia' },
];
