...
import { Page, SectionHeader, MetricCard, LoadingState, ErrorState } from '../ui';
...
export default function DashboardSection() {
  ...
  // Operational metrics only — Active Doctors / Total Revenue / Active Users /
  // STT Requests / AI Report Requests / Storage Used were intentionally removed.
  const metrics = [
