...
// AnvayaScribe landing — the product sections, in the AnvayaBook.ai theme:
// how it works → clinical intelligence → report quality → why doctors choose it.
// Sections alternate white / slate-50 exactly like the AnvayaBook.ai landing.
...
const OUTCOMES = [
  ...
  'Same patients as AnvayaBook.ai',
];
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          <FadeIn className="text-center mb-10">
            <h2 className="font-display text-3xl sm:text-4xl font-extrabold text-slate-900 tracking-tight">
              Why doctors choose AnvayaScribe.
            </h2>
          </FadeIn>
