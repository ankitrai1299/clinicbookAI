...
// AnvayaScribe landing hero — AnvayaBook.ai theme (light slate/white, sky→teal accent,
...
export function NovaHero({ isLoggedIn, onOpen, apkUrl }: HeroProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-white pt-10 pb-20 lg:pt-16 lg:pb-24 border-b border-slate-100">
      {/* Decorative accents — same language as the AnvayaBook.ai hero */}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <FadeIn className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-lg text-slate-600 leading-relaxed mt-5 max-w-2xl mx-auto">
            Record every consultation once. AnvayaScribe listens, transcribes, understands the medical context and
          ...
          <div className="mt-7 flex flex-wrap justify-center gap-x-6 gap-y-2">
            {['Works in Hindi, English & Hinglish', '2-minute setup', 'Shares AnvayaBook.ai patients'].map((f) => (
