        ...
        <div className="lg:col-span-5">
          ...
          <Reveal delay={0.16}>
            <p className="text-lg text-slate-600 leading-relaxed mt-5 max-w-xl">
              AnvayaScribe listens to the consultation, understands the medical conversation, and writes the
          ...
          <Reveal delay={0.24}>
            <div className="flex flex-col sm:flex-row gap-3 mt-8">
              ...
              >
                {isLoggedIn ? 'Open AnvayaScribe' : 'Start free trial'}
            ...
            <div className="relative">
              ...
              <div className="relative rounded-[26px] overflow-hidden shadow-2xl shadow-slate-900/20 ring-1 ring-white/70 aspect-[16/11]">
                <img
                  ...
                  alt="Dr. Arjun Verma using AnvayaScribe during a consultation"
              ...
              >
                ...
                <div className="flex items-center gap-2 px-3.5 py-2.5 bg-slate-50 border-b border-slate-100">
                  ...
                  <span className="ml-1 text-[10.5px] font-semibold text-slate-400">AnvayaScribe — Consultation</span>
