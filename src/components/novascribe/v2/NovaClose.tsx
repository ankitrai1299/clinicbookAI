...
const FAQS = [
  ...
  },
  {
    ...
    a: 'Yes. AnvayaScribe reads and writes through an adapter layer, with OpenEMR and HL7 FHIR supported today, so it sits on top of what you already run rather than replacing it.',
  },
  {
