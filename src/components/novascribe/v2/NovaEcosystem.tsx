...
// AnvayaBook.ai, and what it connects to.
...
// ── S9 · THE FULL LOOP ───────────────────────────────────────
const JOURNEY = [
  { icon: MessageSquare, title: 'Patient books', side: 'AnvayaBook.ai', tone: 'emerald' },
  { icon: CalendarClock, title: 'Appears in your queue', side: 'AnvayaScribe', tone: 'sky' },
  { icon: Mic, title: 'Consultation recorded', side: 'AnvayaScribe', tone: 'sky' },
  { icon: FileText, title: 'Note written', side: 'AnvayaScribe', tone: 'sky' },
  { icon: Pill, title: 'Prescription created', side: 'AnvayaScribe', tone: 'violet' },
  { icon: Send, title: 'Sent on WhatsApp', side: 'AnvayaBook.ai', tone: 'emerald' },
  { icon: Repeat, title: 'Follow-up books itself', side: 'AnvayaBook.ai', tone: 'emerald' },
];
    ...
    <section className="py-24 bg-slate-50 border-y border-slate-100">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHead
          ...
          sub="AnvayaScribe writes the visit. AnvayaBook.ai carries it to the patient — and brings them back."
        />
...
const LIVE = ['WhatsApp Cloud API', 'OpenEMR', 'HL7 FHIR', 'AnvayaBook.ai'];
    ...
    <section className="py-24 bg-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHead
          ...
          sub="AnvayaScribe sits on top of your systems through a ports-and-adapters layer — it doesn't ask you to replace them."
        />
