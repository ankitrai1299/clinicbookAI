...
// recording, the note, the prescription — not a WhatsApp thread: AnvayaScribe's job
...
const PANELS: ShowcasePanelProps[] = [
  ...
  },
  {
    ...
    subtitle:
      'Speak to your patient the way you always do — Hindi, English or Hinglish. AnvayaScribe listens and writes the clinical note and the prescription for you. You read, correct if needed, and sign off.',
    clinicName: 'CarePlus Clinic',
    scene: 'record',
    reverse: true,
    features: [
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <p className="text-lg text-slate-600 mt-4">
            What AnvayaScribe takes off your desk — from the booking you didn’t enter to the prescription you
            didn’t type.
          </p>
        </div>
