...
export default function NovaScribeLanding({ isLoggedIn, onOpen, onBack }: Props) {
  return (
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-slate-500 mt-4 text-lg leading-relaxed">
              Record the consultation — NovaScribe transcribes it (Hindi, English, Hinglish), then drafts a
            ...
            <div className="flex flex-wrap items-center gap-3 mt-7">
              ...
              >
                {isLoggedIn ? 'Open NovaScribe' : 'Sign in to start'} <ArrowRight className="w-4 h-4" />
              </button>
