          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
            ...
            <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
              ...
              <p className="text-lg text-slate-600 max-w-2xl mx-auto lg:mx-0 leading-relaxed" id="hero-subtitle">
                AnvayaBook.ai helps clinics automate appointment booking, reminders, cancellations, and waitlist recovery through WhatsApp. Give your patients a 24/7 multilingual booking agent without hiring.
              </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto space-y-4">
            ...
            <p className="text-slate-600 text-md leading-relaxed">
              AnvayaBook.ai replaces phone tag with direct WhatsApp scheduling, integrated with your calendars.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <h2 className="font-display text-3xl sm:text-4xl font-extrabold tracking-tight leading-tight">
                Already run an EMR or hospital app? <span className="text-sky-400">Plug AnvayaBook.ai in.</span>
              </h2>
              <p className="text-slate-300 text-md leading-relaxed">
                Drop our API key into your system and every appointment it books flows through AnvayaBook.ai —
      ...
      <section className="py-20 bg-sky-900 text-white relative overflow-hidden" id="final-cta-section">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-8">
          ...
          <p className="text-sky-100/90 max-w-2xl mx-auto text-sm sm:text-md leading-relaxed">
            Boost consultation slot utility and save overhead. Join hundreds of smart clinics automating bookings with AnvayaBook.ai.
          </p>
          <div>
            <button
      ...
      <footer className="bg-slate-900 text-slate-400 py-12 border-t border-slate-800 text-xs text-left">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          >
            ...
            <span className="font-display font-bold text-white text-base">AnvayaBook.ai</span>
          </button>
          <div>
